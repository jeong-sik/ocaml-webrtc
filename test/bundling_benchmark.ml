...
let () =
  ...
  Printf.printf "╔═══════════════════════════════════════════════════════════════╗\n";
  Printf.printf
    "║     Bundling Benchmark - Small Packets (%d bytes)           ║\n"
    packet_size;
  Printf.printf "╚═══════════════════════════════════════════════════════════════╝\n\n";
  let shared_tsn =
  ...
  let udp_sender =
    Udp_transport.get_stats (Eio_sctp_full_transport.get_udp_transport sender)
  in
  let udp_recv =
    Udp_transport.get_stats (Eio_sctp_full_transport.get_udp_transport receiver)
  in
